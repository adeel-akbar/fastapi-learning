...
### Chapter 8 — Alembic & API Configuration

- Learned what a database migration tool is and why it's needed
- Set up Alembic and connected it to SQLAlchemy models via `Base.metadata`
- Practiced manual migrations (`create_table`, `add_column`) and autogenerated migrations
